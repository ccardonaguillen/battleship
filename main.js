...
const gameboardView = (owner, gameboard) => {
    ...
    function _createShipsDisplay(display) {
        ...
        for (let ship in _ship__WEBPACK_IMPORTED_MODULE_0__.shipList) {
            ...
            for (let i = 1; i <= _ship__WEBPACK_IMPORTED_MODULE_0__.shipList[ship]; i++) {
    ...
    function _renderAttack({ target, row, col, ship }) {
        ...
        if (target === owner) {
            ...
            const index = owner === 'player' ? shipHP : _ship__WEBPACK_IMPORTED_MODULE_0__.shipList[shipClass] - shipHP - 1;
